#![deny(unsafe_code)]
//! motokano CLI — parse args, wire the server + counter + optional dazai
...
use motokano::dazai::DazaiLink;
use motokano::server::{serve_stdio, OneshotServer};
use motokano::tools::{parse_tool_spec, ToolRegistry};
use motokano::{wipe_and_exit, ExitCtx};
