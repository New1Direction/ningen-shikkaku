# daZai — Python reference implementation

> This is the original Python proof-of-concept (Phase 1). The production tool is
> the hardened Rust workspace in [`rs/`](rs/); see the [main README](README.md).
...
which is exactly what the Rust implementation in [`rs/`](rs/) provides.
